...
std::string PeerInfo::getBencodedInfo() const {
    std::string bencodedResponse;
    bencodedResponse.append("d7:peer_id20:_notTheActualPeerId_");
    bencodedResponse.append("2:ip");
    bencodedResponse.append(""+this->ip.str().length());
    bencodedResponse.append(":");
    bencodedResponse.append(this->ip.str());
    bencodedResponse.append( "4:porti" + this->port);
    bencodedResponse.append("ee");
