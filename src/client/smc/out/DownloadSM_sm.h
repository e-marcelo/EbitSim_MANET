...
// from file : DownloadSM.sm
//

#ifndef DOWNLOADSM_SM_H
#define DOWNLOADSM_SM_H
...
public:
    ...
    DownloadSMState(const char * const name, const int stateId)
...
public:
    ...
    DownloadMap_Default(const char * const name, const int stateId)
...
{
public:
    DownloadMap_Stopped(const char * const name, const int stateId)
...
{
public:
    DownloadMap_NotInterestedChoked(const char * const name, const int stateId)
    : DownloadMap_Default(name, stateId)
    {};
...
{
public:
    DownloadMap_InterestedChoked(const char * const name, const int stateId)
    : DownloadMap_Default(name, stateId)
    {};
...
{
public:
    DownloadMap_NotInterestedUnchoked(const char * const name, const int stateId)
    : DownloadMap_Default(name, stateId)
    {};
...
{
public:
    DownloadMap_InterestedUnchoked(const char * const name, const int stateId)
    : DownloadMap_Default(name, stateId)
    {};
...
public:
    ...
    explicit DownloadSMContext(PeerWireThread& owner)
    ...
    inline DownloadSMState& getState()
    {
        if (_state == NULL)
        {
    ...
    inline void bitFieldMsg(BitFieldMsg const& msg)
    {
    ...
    inline void haveMsg(HaveMsg const& msg)
    {
    ...
    inline void peerNotInteresting()
    {
    ...
    inline void pieceMsg(PieceMsg const& msg)
    {
